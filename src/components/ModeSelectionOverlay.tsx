...
import { Clock, Infinity as InfinityIcon, X, Zap, Skull } from 'lucide-react';
                ...
                <div className="relative flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      3-minute endurance and accuracy test. Difficulty adapts to your skill.
                    </p>
